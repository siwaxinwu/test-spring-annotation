 ...
 * description：
 * author：dingyawu
 * date：created in 23:03 2020/12/6
 * history:
 */
public class PropertyValueTest {
    /**
     * 测试bean的@value注入 ，注入字符串和表达式
     * Worker(name=roy, age=18, systemPropertiesName=Windows 10, randomNumber=14.869541521378205, url=URL [http://www.baidu.com])
     */
    @Test
    ...
    public void testTeacherPropertyValue(){
        //创建IOC容器
        AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(TeacherValueConfig.class);
    ...
    public void testPropertyValue03(){
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(TeacherValueConfig.class);
